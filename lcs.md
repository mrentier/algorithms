...
Given M &ge; 0, N &ge; 0 and arrays x\[0...M) and y\[0...N), derive a program for the computation of the length of a longest common subsequence (LCS) of x and y. 
Define function l&#8729;m&#8729;n as the length of the longest common subsequence of x\[0...m) and y\[0...n) with 0&le;m&lt;M and 0&le;n&lt;N.
...
&equiv; \{ substitute \}<br/>
(&forall;i: 0&le;i&le;n+1: h&#8729;i = l&#8729;(m+1)&#8729;i)<br/>
...
Time complexity is O(M\*N) and space complexity O(N) (note that O(min(M,N)) is easily achieved by choosing the smallest array for y). All arrays are traversed from left to right, so they can be for example files. Note that we relied upon N for initialization of h. This dependency was removed by introducing a list for h.
